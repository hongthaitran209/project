        ...
        return (
            <div className="footer">
                <div className="footer__about footer__item">
                    <div className="footer__about__header">ABOUT learningzone</div>
                ...
                <div className="footer__info footer__item">
                    <div className="footer__info__header">INFORMATION</div>
                ...
                <div className="footer__student footer__item">
                    <div className="footer__student__header ">INFORMATION</div>
                ...
                <div className="instag footer__item">
                    <div className="instag__header">INSTAGRAM</div>
